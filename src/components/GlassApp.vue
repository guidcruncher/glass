<template>
  ...
  >
    <GlassAppBar ref="appBarRef" @toggle-drawer="handleSideBarClick">
      <template #left>
        <GlassButton
    ...
    <div v-if="isMobile && isSidebarOpen" class="glass-drawer-overlay" @click="closeSideBar"></div>
    ...
    <div class="glass-app__main-content" style="overflow: auto">
...
<style scoped>
@use '../scss/components/GlassApp.scss';
